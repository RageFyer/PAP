...
<body>
    <a href="../frontend/landing_page.php">
        <div class="arrow">
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="input">
                ...
                <a id="forgot" href="forgotpass_page.php">Esqueceste-te da palavra-pass?</a>
            </div>
            <div class="input">
                <input id="submit" type="submit" value="Login">
            </div>
        </form>
        <p id="signup">Não tens conta? <a href="register_page.php">Regista-te</a></p>
    </div>
    ...
    <?php
        if ($_SERVER['REQUEST_METHOD'] ===  "POST"){
            ...
            if(empty($username)){
                ...
                $dataprovider->getUser($username, $password);
            }
        }
    ?>
</body>
